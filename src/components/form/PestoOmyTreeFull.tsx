...
const urlType = defineDataType<URL>({
  ...
  Component: (props: { value: { toString: () => any } }) => {
      ...
      >
        <FormControlLabel
          control={(
            <Switch
              checked={editable}
              onChange={(event: { target: { checked: boolean | ((prevState: boolean) => boolean) } }) => setEditable(event.target.checked)}
            />
          )}
          label='Editable'
        />
        <FormControlLabel
          control={(
            <Switch
              ...
              onChange={(event: {
                  target: {
                    checked: boolean | ((prevState: boolean
                      // https://github.com/TexteaInc/json-viewer/blob/main/docs/pages/full/index.tsx
                    ) => boolean //github.com/TexteaInc/json-viewer/blob/main/docs/pages/full/index.tsx
                    )
                  }
                }) => setHighlightUpdates(event.target.checked)}
            />
          )}
        ...
        <FormControlLabel
          control={(
            <Switch
              ...
              onChange={(event: { target: { checked: boolean | ((prevState: boolean) => boolean) } }) => setDisplayDataTypes(event.target.checked)}
            />
          )}
        ...
        <FormControlLabel
          control={(
            <Switch
              checked={displaySize}
              onChange={(event: { target: { checked: boolean | ((prevState: boolean) => boolean) } }) => setDisplaySize(event.target.checked)}
            />
          )}
        ...
        >
          ...
          <Select
            value={themeKey}
            label='Theme'
            onChange={(event: SelectChangeEvent<string>, child: ComponentChild) => {
              // event.
              if (event.target) {
